	...
	double precision eps,M(nS1,nS1), bpay(nS1), pR,pS,pT,pP,
	...
	implicit none
	integer, parameter :: nS1=16
	double precision pI(nS1),pJ(nS1),M(nS1,nS1)
	integer i,j
	M=0.d0
	...
	M(2,1)=pI(2)*pJ(3)
	M(2,5)=pI(2)*(1.d0-pJ(3))
	M(2,9)=(1.d0-pI(2))*pJ(3)
	M(2,13)=(1.d0-pI(2))*(1.d0-pJ(3))

	M(3,1)=pI(3)*pJ(2)
	M(3,5)=pI(3)*(1.d0-pJ(2))
	M(3,9)=(1.d0-pI(3))*pJ(2)
	M(3,13)=(1.d0-pI(3))*(1.d0-pJ(2))

	M(4,1)=pI(4)*pJ(4)
	M(4,5)=pI(4)*(1.d0-pJ(4))
	M(4,9)=(1.d0-pI(4))*pJ(4)
	M(4,13)=(1.d0-pI(4))*(1.d0-pJ(4))



	M(5,2)=pI(5)*pJ(9)
	M(5,6)=pI(5)*(1.d0-pJ(9))
	M(5,10)=(1.d0-pI(5))*pJ(9)
	M(5,14)=(1.d0-pI(5))*(1.d0-pJ(9))

	M(6,2)=pI(6)*pJ(11)
	M(6,6)=pI(6)*(1.d0-pJ(11))
	M(6,10)=(1.d0-pI(6))*pJ(11)
	M(6,14)=(1.d0-pI(6))*(1.d0-pJ(11))

	M(7,2)=pI(7)*pJ(10)
	M(7,6)=pI(7)*(1.d0-pJ(10))
	M(7,10)=(1.d0-pI(7))*pJ(10)
	M(7,14)=(1.d0-pI(7))*(1.d0-pJ(10))

	M(8,2)=pI(8)*pJ(12)
	M(8,6)=pI(8)*(1.d0-pJ(12))
	M(8,10)=(1.d0-pI(8))*pJ(12)
	M(8,14)=(1.d0-pI(8))*(1.d0-pJ(12))



	M(9,3)=pI(9)*pJ(5)
	M(9,7)=pI(9)*(1.d0-pJ(5))
	M(9,11)=(1.d0-pI(9))*pJ(5)
	M(9,15)=(1.d0-pI(9))*(1.d0-pJ(5))

	M(10,3)=pI(10)*pJ(7)
	M(10,7)=pI(10)*(1.d0-pJ(7))
	M(10,11)=(1.d0-pI(10))*pJ(7)
	M(10,15)=(1.d0-pI(10))*(1.d0-pJ(7))

	M(11,3)=pI(11)*pJ(6)
	M(11,7)=pI(11)*(1.d0-pJ(6))
	M(11,11)=(1.d0-pI(11))*pJ(6)
	M(11,15)=(1.d0-pI(11))*(1.d0-pJ(6))

	M(12,3)=pI(12)*pJ(8)
	M(12,7)=pI(12)*(1.d0-pJ(8))
	M(12,11)=(1.d0-pI(12))*pJ(8)
	M(12,15)=(1.d0-pI(12))*(1.d0-pJ(8))



	M(13,4)=pI(13)*pJ(13)
	M(13,8)=pI(13)*(1.d0-pJ(13))
	M(13,12)=(1.d0-pI(13))*pJ(13)
	M(13,16)=(1.d0-pI(13))*(1.d0-pJ(13))

	M(14,4)=pI(14)*pJ(15)
	M(14,8)=pI(14)*(1.d0-pJ(15))
	M(14,12)=(1.d0-pI(14))*pJ(15)
	M(14,16)=(1.d0-pI(14))*(1.d0-pJ(15))

	M(15,4)=pI(15)*pJ(14)
	M(15,8)=pI(15)*(1.d0-pJ(14))
	M(15,12)=(1.d0-pI(15))*pJ(14)
	M(15,16)=(1.d0-pI(15))*(1.d0-pJ(14))

	M(16,4)=pI(16)*pJ(16)
	M(16,8)=pI(16)*(1.d0-pJ(16))
	M(16,12)=(1.d0-pI(16))*pJ(16)
	M(16,16)=(1.d0-pI(16))*(1.d0-pJ(16))
